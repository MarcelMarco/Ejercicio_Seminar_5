...
const getListOfUsers=async(id:string)=>{
...
export { insertSubject, getSubject, getSubjects, updateSubject, deleteSubject, matriculateSubject, getListOfUsers, getListOfSubjects};
